...
export const hrApi = {
    ...
    getFinanceExecutiveDashboard: (params) => api.get("/hr/finance-expenses/my-dashboard", { params }),
    
    // Expense Summaries (from Finance module)
    getFinanceProjectExpenses: (projectId) => api.get(`/finance/expenses/project/${projectId}`),
    getFinanceEmployeeExpenses: (employeeId, params) => api.get(`/finance/expenses/employee/${employeeId}`, { params }),
    getFinanceExpenseSummary: (params) => api.get("/finance/expenses/summary", { params }),
