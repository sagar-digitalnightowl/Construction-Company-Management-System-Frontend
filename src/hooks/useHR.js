...
// 		try {
// 			const res = await hrApi.getWalletTransactions(params);
...
// 		try {
// 			const res = await hrApi.getExpenseCategories();
...
// 		// ❌ removed proof variable + its required check — proof is optional now
