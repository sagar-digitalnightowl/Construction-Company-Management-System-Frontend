...
export function CreateBookingDialog({ open, onOpenChange, onSuccess }) {
  ...
  const handleSubmit = async () => {
    // Basic validation
    if (!form.projectId || !form.flatId || !form.bookingAmount) {
      toast.error("Project, flat and booking amount are required");
      return;
    }
    ...
    if (form.leadId) {
      ...
      // Personal details (only include non-empty fields)
      ...
      // Permanent address (only if at least line1 or city provided)
      ...
      // Bank details (only if at least bankName or accountNumber provided)
      const bankDetails = {};
