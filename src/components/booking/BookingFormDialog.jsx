...
// //working only customer type is not here
// import React, { useState, useEffect, useRef } from "react";
// import {
//   Dialog,
//   DialogContent,
...
//         // 💡 FRONTEND FIX 1: Auto-heal if the saved flatId is invalid/regenerated
...
//           );
//           if (flatObj) {
//             activeFlatId = flatObj._id; // Update to the new valid ID
//           }
//         }
...
//           towerName: towerName,
//           floor: floor.toString(),
//           flatId: activeFlatId || "", // 💡 Set the healed activeFlatId here
...
//       payload.nomineeRelation = form.nomineeRelation || undefined;
//     } else {
//       // 💡 FRONTEND FIX 2: Send the healed flatId to the backend on edit so DB gets permanently corrected
//       payload.flatId = form.flatId;
//     }
