    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                key: "procurement",
                children: [
                    { to: "/procurement/dashboard", label: "Dashboard", key: "procurement-overview" },
                    { to: "/procurement/rfqs", label: "RFQs", key: "procurement-rfqs" },
                    { to: "/procurement/quotations", label: "Quotations", key: "procurement-quotations" },
                    { to: "/procurement/purchase-orders", label: "Purchase Orders", key: "procurement-pos" },
                    { to: "/procurement/deliveries", label: "Deliveries", key: "procurement-deliveries" },
                ],  
            },
            {
                to: "/vendor/dashboard",
            ...
            },
            {
                ...
                key: "inventory",
                children: [
                    { to: "/inventory/stock-management", label: "Stock Management", key: "inventory-stock-management" },
                    { to: "/inventory/materials", label: "Materials Master", key: "inventory-materials" },
                    { to: "/inventory/warehouses", label: "Warehouses", key: "inventory-warehouses" },
                    { to: "/inventory/transactions", label: "Stock Transactions", key: "inventory-transactions" },
