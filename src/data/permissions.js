...
//     dashboard: ["admin", "director", "project_manager", "site_engineer", "accountant", "finance_executive", "hr_manager", "vendor", "client", "employee"],
//     users: ["admin"],
//     projects: ["admin", "director", "project_manager", "site_engineer", "accountant"], // Removed finance_executive
//     "project-templates": ["admin", "director", "project_manager", "site_engineer", "accountant"], // Removed finance_executive
//     "property-inventory": ["admin", "director", "project_manager", "accountant", "finance_executive"],
//     "site-management": ["admin", "director", "project_manager", "site_engineer"],
//     tasks: ["admin", "director", "project_manager", "site_engineer"],
//     procurement: ["admin", "director", "project_manager", "accountant", "finance_executive"],
...
//     // --- NEW EXPENSE SYSTEM VIEW PERMISSIONS ---
//     "finance-module": ["admin", "director", "accountant", "finance_executive"], // Parent menu for Finance & Accounts
//     "hr-module": ["admin", "director", "hr_manager", "accountant"], // Removed finance_executive from HR parent menu
//     "my-expenses": ["admin", "director", "project_manager", "site_engineer", "accountant", "finance_executive", "hr_manager", "employee"], // Everyone except external clients/vendors
//     "expense-approvals": ["admin", "director", "hr_manager", "accountant", "finance_executive"], // Only Management & Finance
    
//     leaves: ["admin", "director", "project_manager", "site_engineer", "accountant", "hr_manager", "employee"], // Removed finance_executive
//     crm: ["admin", "director", "project_manager", "hr_manager", "employee"],
//     documents: ["admin", "director", "project_manager", "site_engineer", "accountant", "vendor"], // Removed finance_executive
//     reports: ["admin", "director"],
//     settings: ["admin", "director", "project_manager", "site_engineer", "accountant", "finance_executive", "hr_manager", "vendor", "client", "employee"],
// };
...
//   "my-expenses": ["admin", "director", "project_manager", "site_engineer", "accountant", "finance_executive", "hr_manager", "employee"],
...
//   "my-expenses": ["admin", "director", "project_manager", "site_engineer", "accountant", "finance_executive", "hr_manager", "employee"],
//   "expense-payment": ["admin", "accountant", "finance_executive"], // Optional internal strict check for payment button
...
//   // 👇 CHANGED: Removed "hr_manager" from here
//   crm: ["admin", "director", "project_manager", "employee"], 
