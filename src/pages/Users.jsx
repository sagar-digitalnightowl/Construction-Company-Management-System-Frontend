...
// import { initials } from "@/lib/helpers";
// import { authApi } from "@/api";
// import { hrApi } from "@/api/hrApi"; // 🆕 Added for fetching departments
...
//                     role: freshUser.role || "",
//                     employeeId: freshUser.employeeId || "",
//                     department: freshUser.department?._id || freshUser.department || "", // 🆕 Handle department ID
//                     password: "",
//                     status: freshUser.isActive ? "active" : "inactive",
//                     dateOfBirth: personal.dateOfBirth?.slice(0, 10) || "",
//                     gender: personal.gender || "",
...
//                                         </Select>
//                                     </div>
//                                     {/* 🆕 Updated Department field - now a Select dropdown */}
//                                     <div className="space-y-1.5">
//                                         <Label>Department</Label>
...
//     const { current } = useAuthStore();
//     const [search, setSearch] = useState("");
//     const [debouncedSearch, setDebouncedSearch] = useState(""); // 🆕 Debounce for API call
//     const [roleFilter, setRoleFilter] = useState("all");
//     const [open, setOpen] = useState(false);
//     const [editing, setEditing] = useState(null);
//     const [viewMode, setViewMode] = useState(false);
...
//     // 🆕 Update debounced search on input change
//     useEffect(() => {
...
//     // 🆕 Fetch API implementation (Server Side Filtering)
//     const fetchUsers = async () => {
//         try {
...
//     // 🆕 Trigger fetch when page, limit, search, or role changes
//     useEffect(() => {
//         fetchUsers();
...
//     // 🆕 Handle Role Change (Reset to page 1)
//     const handleRoleChange = (val) => {
//         setRoleFilter(val);
//         setPage(1);
//     };

//     // Status Toggle & other unchanged functions...
//     const handleStatusToggle = async (user) => { /* unchanged */ };
//     const startCreate = () => { /* unchanged */ };
//     const resetFiles = () => { /* unchanged */ };
//     const loadUserDetails = async (user, isViewMode) => { /* unchanged */ };
//     const viewUser = (user) => loadUserDetails(user, true);
//     const startEdit = (user) => loadUserDetails(user, false);
//     const handleDelete = async () => { /* unchanged */ };
    
//     const validateStep1 = () => { /* unchanged */ };
//     const validateStep2 = () => { /* unchanged */ };
//     const validateStep3 = () => { /* unchanged */ };
//     const handleNext = () => { /* unchanged */ };
//     const handleBack = () => { /* unchanged */ };
    
//     const uploadFileWithPresignedUrl = async (file, fileType) => { /* unchanged */ };
//     const handleFileSelect = (e, setFile, setPreview, fileType) => { /* unchanged */ };
//     const uploadAllFiles = async () => { /* unchanged */ };
//     const buildRegisterPayload = (uploadedKeys = {}) => { /* unchanged */ };
//     const buildUpdatePayload = () => { /* unchanged */ };
    
//     const save = async () => { /* unchanged */ };
//     const verifyOtp = async () => { /* unchanged */ };

//     const canEdit = canMutate(current?.role, "users");

//     // 🆕 Filter out "client" role locally in case API sends it when fetching "all"
...
//                     <SelectTrigger className="w-[200px]" data-testid="users-role-filter">
//                         <SelectValue placeholder="Select Role" />
//                     </SelectTrigger>
//                     <SelectContent>
//                         <SelectItem value="all">All roles</SelectItem>
//                         {/* 🆕 Exclude client from role dropdown list */}
...
//                             {displayUsers.map((u) => (
//                                 <TableRow key={u._id} data-testid={`user-row-${u._id}`}>
//                                     {/* Unchanged TableCell contents */}
//                                     {/* ... Omitted purely for brevity in this response but keep them in your file ... */}
//                                 </TableRow>
//                             ))}
//                         </TableBody>
//                     </Table>
