...
import {
  ...
  FileText,
  Building2,
  Image as ImageIcon // 👈 Yahan ImageIcon import kiya hai
} from "lucide-react";
import { ProjectHeader } from "@/components/project/ProjectHeader";
import { ProjectStats } from "@/components/project/ProjectStats";
import { OverviewTab } from "@/components/project/OverviewTab";
...
import { DocumentsTab } from "@/components/project/DocumentsTab";
import { TowersTab } from "@/components/project/TowersTab";
import { MediaTab } from "@/components/project/MediaTab"; // 👈 Naya MediaTab component import kiya
      ...
      <Tabs defaultValue="overview">
        <div className="w-full h-full overflow-auto scrollbar-none">
          <TabsList>
            ...
            {/* 🔴 NAYA MEDIA TAB TRIGGER YAHAN ADD KIYA HAI */}
        ...
        <div className="mt-5">
          ...
          {/* 🔴 NAYA MEDIA TAB CONTENT YAHAN ADD KIYA HAI */}
          <TabsContent value="media">
            <MediaTab project={project} />
          </TabsContent>

          {/* ... BAQI SAARE TABS WAISE HI RAHENGE ... */}
          <TabsContent value="dpr">
            <DprTab projectId={project._id} canOperationsEdit={canOperationsEdit} />
          </TabsContent>
          <TabsContent value="checklist">
            <ChecklistTab projectId={project._id} canOperationsEdit={canOperationsEdit} />
          </TabsContent>
          <TabsContent value="resources">
            <ResourceTab projectId={project._id} canEdit={canEdit} />
          </TabsContent>
          ...
          <TabsContent value="milestones">
            <MilestonesTab project={project} milestones={milestones} canEdit={canEdit} onAddMilestone={addMilestone} />
          </TabsContent>
          <TabsContent value="boq">
            <BOQTab boq={boq} canEdit={canEdit} onAddBOQItem={(data) => addBOQItem(project._id, data)} />
          </TabsContent>
          <TabsContent value="issues">
            <IssuesTab issues={issues} canOperationsEdit={canOperationsEdit} teamMembers={project.teamMembers || []} onAddIssue={(data) => addIssue(project._id, data)} onResolveIssue={(issueId) => resolveIssue(project._id, issueId)} />
          </TabsContent>
          <TabsContent value="risks">
            <RisksTab risks={risks} canEdit={canEdit} onAddRisk={(data) => addRisk(project._id, data)} />
          </TabsContent>
          <TabsContent value="materials">
            <MaterialRequestsTab projectId={project._id} canEdit={canEdit} />
          </TabsContent>
          <TabsContent value="tasks">
            {current?.role === "site_engineer" ? (
              ...
              <TasksTab projectId={project._id} milestones={milestones} teamMembers={project.teamMembers || []} canEdit={canEdit} canOperationsEdit={canOperationsEdit} />
            )}
          </TabsContent>
          <TabsContent value="activity">
            <ActivityTab projectId={project._id} />
          ...
          <TabsContent value="documents">
            <DocumentsTab projectId={project._id} canEdit={canEdit} canOperationsEdit={canOperationsEdit} />
          </TabsContent>
        </div>
      </Tabs>
    </div>
